      ...
      <div className="section-container">
        <div className="card">
          <div className="card-content">
            <img
              src="license_24dp_D69E2E_FILL0_wght400_GRAD0_opsz24.svg"
              alt="certificate-icon"
            />
            Request Certificates
            <img
              src="arrow_forward_24dp_2D3748_FILL0_wght400_GRAD0_opsz24.svg"
        ...
        <div className="card">
          <div className="card-content">
            <img
              src="calendar_today_24dp_D69E2E_FILL0_wght400_GRAD0_opsz24.svg"
          ...
          <div className="card-content">
            <p className="card-text">
              Schedule meetings with your Grama Niladhari officer at convenient
              times.
            </p>
          </div>
        </div>
        ...
        <div className="card">
          <div className="card-content">
            <img
              src="list_alt_24dp_D69E2E_FILL0_wght400_GRAD0_opsz24.svg"
        ...
        <div className="card">
          <div className="card-content">
            <img
              src="edit_document_24dp_D69E2E_FILL0_wght400_GRAD0_opsz24.svg"
              alt="track-requests-icon"
            />
        ...
        <div className="card">
          <div className="card-content">
            <img
              src="brand_awareness_24dp_D69E2E_FILL0_wght400_GRAD0_opsz24.svg"
              alt="track-requests-icon"
            />
            Announcements
            <img
